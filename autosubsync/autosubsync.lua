...
local config = {
    ...
    ffmpeg_path = "",
    ffsubsync_path = "C:\\Users\\muham\\AppData\\Local\\Programs\\Python\\Python39\\Scripts\\ffsubsync.exe",
    alass_path = "C:\\Program Files\\mpv\\mpv\\scripts\\autosubsync\\alass-cli.exe",
